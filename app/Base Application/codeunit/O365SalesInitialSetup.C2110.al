...
codeunit 2110 "O365 Sales Initial Setup"
{
    ...
    local procedure InitializeReportSelection(ReportID: Integer; ReportUsage: Enum "Report Selection Usage"; LayoutCode: Code[20]; EmailBodyLayoutCode: Code[20]; EmailBodyLayoutType: Enum "Email Body Layout Type")
    var
